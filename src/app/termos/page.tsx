  ...
  return (
    <ContentContainer>
      <TermsContainer>
        ...
        <p>
          <span>
            A sua privacidade é importante para nós. É política da Galaxy Store
            respeitar a sua privacidade em relação a qualquer informação sua que
            possamos coletar no site {""}
            <Link href="/">Galaxy Store</Link>, e outros sites que possuímos e
            operamos.
          </span>
        </p>
        <p>
        ...
        <p>
          <span>
            ...
            informação que o GalaxyStore oferece no site e com caráter
        ...
        <ul>
          ...
          <li>
            <span>
              ...
              (softwares) do GalaxyStore, de seus fornecedores ou terceiros,
        ...
        <p>
          <span>
            Esta política é efetiva a partir de&nbsp;29 August 2023 18:34
          </span>
        </p>
      </TermsContainer>
    </ContentContainer>
